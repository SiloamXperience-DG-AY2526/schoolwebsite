...
<div class="wp-block-group max-w-7xl mx-auto px-6">
  ...
  <div class="wp-block-group bg-white rounded-2xl shadow-2xl p-8 relative">
    ...
    <!-- Close Button -->
    <!-- wp:html -->
    <button class="absolute top-6 right-6 text-gray-400 hover:text-gray-600 transition">
    ...
    <div class="wp-block-group grid grid-cols-2 gap-8">
      ...
      <div class="wp-block-group space-y-6">
        ...
        <div class="wp-block-group space-y-2">
          ...
          <p class="text-neutral-120 text-paragraph-sm">Description</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      ...
      <div class="wp-block-group flex flex-col">
        ...
        <!-- wp:image {"sizeSlug":"large","className":"w-full h-96 object-cover mb-6"} -->
        <figure class="wp-block-image size-large w-full h-96 object-cover mb-6">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/listing/students.jpg" alt="Volunteer teaching students" />
        </figure>
        <!-- /wp:image -->
