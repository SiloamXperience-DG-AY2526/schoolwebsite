...
<div class="wp-block-group relative flex flex-wrap w-full min-h-[90vh]">
    ...
    <div class="wp-block-group flex flex-col items-end justify-center h-[75vh] bg-[#7EDDC3]/60 flex-1">
        ...
        <div class="wp-block-group flex-col items-end p-12 max-w-5xl">

            <!-- wp:heading {"className":"text-[34px] 2xl:text-[56px] font-semibold mb-6"} -->
            <h2 class="wp-block-heading text-[34px] 2xl:text-[56px] text-right font-semibold mb-6">
            ...
            <p class="text-gray-800 font-medium text-[18px] 2xl:text-[30px] text-right leading-relaxed">
    ...
    <!-- wp:image {"sizeSlug":"large","className":"absolute -top-4 left-4 w-[10rem] lg:w-[18rem] xl:w-[22rem] 2xl:w-[38rem] shadow-lg z-10"} -->
    <figure class="wp-block-image corner-images size-medium absolute -top-4 left-4 w-[10rem] lg:w-[18rem] xl:w-[22rem] 2xl:w-[38rem] shadow-lg z-10">
        <img
