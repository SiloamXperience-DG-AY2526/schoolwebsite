...
<!-- wp:group {"className":"hero-section flex flex-col items-center justify-center text-center px-5 pt-20","layout":{"type":"constrained"}} -->
<div class="wp-block-group hero-section flex flex-col items-center justify-center text-center px-5 pt-24">
    <!-- wp:heading {"textAlign":"center","level":1,"className":"text-4xl md:text-5xl font-bold text-accent mb-4"} -->
    <h1 class="wp-block-heading has-text-align-center text-4xl md:text-5xl 2xl:text-[70px] font-bold text-accent mb-4 leading-tight">
    ...
    <p class="has-text-align-center text-brand max-w-2xl 2xl:text-[28px] 2xl:max-w-3xl leading-8 mx-auto text-lg mb-8">
