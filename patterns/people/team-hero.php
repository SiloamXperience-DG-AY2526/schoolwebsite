    ...
    <div class="wp-block-group max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="wp-block-group grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
            ...
            <div class="wp-block-group">
                ...
                <h1 class="wp-block-heading text-3xl sm:text-4xl lg:text-header-xxl bg-gradient-to-b from-eucalyptus-110 to-elm-100 bg-clip-text mb-4 text-transparent leading-tight">
                    Our People,<br>
                    <span class="relative inline-block bg-gradient-to-b from-eucalyptus-110 to-elm-100 bg-clip-text text-transparent">
                        ...
                        <figure class="wp-block-image size-full absolute -top-4 left-3/4 -translate-x-1/2 w-24 sm:w-32 lg:w-[159px] h-auto">
                ...
                <p class="text-neutral-700 text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed">
                ...
                <div class="wp-block-buttons">
                    ...
                    <div class="wp-block-button join-button cursor-pointer">
                        <a href="/people/listing/all-categories" class="wp-block-button__link">
                            Join us
                        </a>
                    </div>
                    <!-- /wp:button -->
            ...
            <figure class="wp-block-image size-full pl-10 w-full h-full object-cover">
