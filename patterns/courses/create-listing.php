...
<div class="wp-block-group relative flex flex-col w-full">
    ...
    <div class="wp-block-group flex justify-evenly items-center gap-4 mb-8 py-8 flex-wrap w-full">
        ...
        <div class="flex items-center gap-2.5">
            ...
            <span class="text-slate-700 text-xl font-semibold">Company Details</span>
        </div>
        ...
        <div class="flex items-center gap-2.5">
            ...
            <span class="text-slate-700 text-xl font-semibold">Internship Information</span>
        </div>
        ...
        <div class="flex items-center gap-2.5">
            ...
            <span class="text-slate-700 text-xl font-semibold">Description & Responsibilities</span>
        </div>
        ...
        <div class="flex items-center gap-2.5">
            ...
            <span class="text-slate-700 text-xl font-semibold">Preview and Submission</span>
        </div>
